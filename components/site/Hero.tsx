...
export function Hero({ hero, meta }: { hero: HeroContent; meta: Meta }) {
  return (
    <section id="top" className="paper-grain relative overflow-hidden bg-paper">
      ...
      <div className="gutter grid items-center gap-12 pb-16 pt-14 sm:pb-24 sm:pt-20 lg:grid-cols-[1.25fr_0.85fr] lg:gap-16 lg:pb-32 lg:pt-24">
        <div>
          <Reveal kind="fade">
          ...
          <Reveal kind="up" delay={60}>
            <h1 className="font-display text-balance-tight text-[clamp(2.6rem,7.6vw,5.25rem)] font-semibold leading-[0.95] tracking-[-0.035em] text-ink">
              {hero.headlineBefore}{' '}
          ...
          <Reveal kind="up" delay={120}>
            <p className="mt-7 max-w-xl text-[1.06rem] leading-[1.65] text-ink-soft sm:text-[1.12rem]">
              {hero.subhead}
            </p>
          </Reveal>
          ...
          <Reveal kind="fade" delay={260}>
            <p className="mt-10 flex flex-wrap items-center gap-x-3 gap-y-1 font-mono text-[0.68rem] uppercase tracking-[0.16em] text-ink-soft/80">
